    ...
    <div class="center">
        ...
        <div class="main_menu_area">
            <ul id="nav">
                ...
                <c:if test="${role}">
                    <li><a href="../asm/get-all-the-loai">Quản lý thể loại</a></li>
                    <li><a href="../asm/get-all-user">Quản lý user</a></li>
                </c:if>
            </ul>
        </div>
        <div class="content-bottom__list">
            ...
            <div class="row" style="padding: 20px 50px">
                <div class="col-md-12">
                    <form action="../asm/get-all-user" method="post">
                        <h1> Sửa user </h1>

                        <fieldset>
                            <label for="id">User Id:</label>
                            <input type="text" required id="id" name="id" value="${user.id}" readonly>

                            <label for="fullname">Full name:</label>
                            <input type="text" required id="fullname" name="fullname" value="${user.fullname}">

                            <label for="password">Password:</label>
                            <input type="text" required id="password" name="password" value="${user.password}">
                        </fieldset>

                        <button type="submit" value="update" name="action">Hoàn thành sửa</button>
