                ...
                <div class="col-md-12">
                    <form action="../asm/quan-ly-get-all" method="post">
                        ...
                        <fieldset>
                            ...
                            <legend><span class="number">2</span> Thể loại</legend>
                            ...
                            <select id="category" name="category">
                                <optgroup label="Thể loại">
                                    <c:forEach var="category" varStatus="i" items="${categoryList}">
                                        <option value="${category.id}"
                                                <c:if test="${articleRequest.category.id == category.id}">selected</c:if>>
                                                ${category.name}
                                        </option>
                                    </c:forEach>
                                </optgroup>
