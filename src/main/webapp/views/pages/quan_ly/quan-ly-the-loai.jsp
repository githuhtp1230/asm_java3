...
<head>
    ...
    <LINK
            REL="StyleSheet"
            HREF="${pageContext.request.contextPath}/assets/style/quan-ly-the-loai.css?v=1.0"
            TYPE="text/css"></LINK>
    <LINK
            REL="StyleSheet"
    ...
    <div class="center">
        ...
        <div class="table-wrapper">
            <table class="fl-table">
                ...
                <tbody>
                <c:forEach varStatus="i" var="category" items="${categoryList}">
                <tr>
                    <td>${category.id}</td>
                    <td>${category.name}</td>
                    <td>
                        <a href="../asm/update-the-loai?categoryId=${category.id}">Update</a>
                        <a href="../asm/delete-the-loai?categoryId=${category.id}">Delete</a>
                    </td>
                </tr>
                </c:forEach>
                <tbody>
